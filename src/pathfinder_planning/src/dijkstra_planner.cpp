...
#include "pathfinder_planning/dijkstra_planner.hpp"

namespace pathfinder_planning
{
...
PLUGINLIB_EXPORT_CLASS(pathfinder_planning::DijkstraPlanner, nav2_core::GlobalPlanner)