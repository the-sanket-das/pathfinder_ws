...
#include "pathfinder_motion/pd_motion_planner.hpp"

namespace pathfinder_motion
{
...
PLUGINLIB_EXPORT_CLASS(pathfinder_motion::PDMotionPlanner, nav2_core::Controller)